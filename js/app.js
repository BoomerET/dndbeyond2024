...
$(function () {
  ...
  $("#grabChar").on("click", function () {
    if (!$("#getcharID").val().trim().match(/\d+/)) {
      ...
      var resetMe = confirm(
        "You need to clear previous data, do you want me to do that for you?"
      );
      if (resetMe == 1) {
        window.location.reload(false);
      }
...
function parseCharacter(inputChar) {
  ...
  if (charStatus.hasOwnProperty("errorCode")) {
    ...
    if (foundLegacy == true) {
      ...
      alertString +=
        "This tool has been designed specifically for the 2024 Players handbook.\n";
      alertString +=
        "Things may work, or they may not. That's the chance you're taking.\n";
      alert("Character " + $("#getcharID").val() + alertString);
    }
    startXML = '<?xml version="1.0" encoding="utf-8"?>\n';
    startXML +=
      '<root version="4.3" dataversion="20220901" release="8.1|CoreRPG:6">\n';
    if (charType == "pc") {
      startXML += "\t<character>\n";
      endXML = "\t</character>\n</root>\n";
    } else {
    ...
    justAbilities.some(function (thisAbility, ja) {
      ...
      buildXML +=
        '\t\t\t\t<savemodifier type="number">' +
        addSavingThrows +
        "</savemodifier>\n";
      character.modifiers.class.some(function (thisMod) {
        // No idea why this has to be 468
        if (
          thisMod.subType == thisAbility + "-saving-throws" &&
          thisMod.type == "proficiency"
        ) {
    ...
    skills.some(function (element) {
      ...
      buildXML +=
        '\t\t\t\t<stat type="string">' + skillsRef[idCount - 1] + "</stat>\n";
      ...
      if (proficiencies != null) {
        proficiencies.some(function (prof) {
          ...
          if (
            skill == element &&
            (prof.componentId == startingClassID ||
              prof.componentId == backgroundID)
          ) {
            profValue = 1;
          }
        });
      ...
      $.each(character.modifiers.background, function (index, value) {
        if (
          value.type == "proficiency" &&
          value.subType.replace(/-/g, "_") == element
        ) {
          profValue = 1;
        }
      });
    ...
    if (finalAncestry != "") {
      ...
      switch (finalAncestry) {
        case "Drow":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00001@*</recordname>\n";
          break;
        case "High":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00002@*</recordname>\n";
          break;
        case "Wood":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00003@*</recordname>\n";
          break;
        case "Cloud":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00004@*</recordname>\n";
          break;
        case "Forest":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00006@*</recordname>\n";
          break;
        case "Rock":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00007@*</recordname>\n";
          break;
        case "Abyssal":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00008@*</recordname>\n";
          break;
        case "Cthonic":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00009@*</recordname>\n";
          break;
        case "Infernal":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00010@*</recordname>\n";
          break;
        case "Black":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00011@*</recordname>\n";
          break;
        case "Blue":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00012@*</recordname>\n";
          break;
        case "Brass":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00013@*</recordname>\n";
          break;
        case "Bronze":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00014@*</recordname>\n";
          break;
        case "Copper":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00015@*</recordname>\n";
          break;
        case "Gold":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00016@*</recordname>\n";
          break;
        case "Green":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00017@*</recordname>\n";
          break;
        case "Red":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00018@*</recordname>\n";
          break;
        case "Silver":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00019@*</recordname>\n";
          break;
        case "White":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00020@*</recordname>\n";
          break;
        case "Fire":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00022@*</recordname>\n";
          break;
        case "Frost":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00023@*</recordname>\n";
          break;
        case "Hill":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00024@*</recordname>\n";
          break;
        case "Stone":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00025@*</recordname>\n";
          break;
        case "Storm":
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00026@*</recordname>\n";
          break;
        default:
          buildXML +=
            "\t\t\t<recordname>race_subrace.id-00042@*</recordname>\n";
      }
    ...
    character.classes.some(function (current_class, i) {
      ...
      if (thisClass == "barbarian") {
        ...
        thisClass == "blood hunter" ||
        thisClass == "blood hunter (archived)"
      ) {
        isBloodHunter = 1;
      ...
      if (
        ...
        (thisClass == "paladin" || thisClass == "ranger") &&
        current_class.level >= 2
      ) {
        buildXML +=
          '\t\t\t\t<casterlevelinvmult type="number">2</casterlevelinvmult>\n';
      } else if (
        (thisClass == "rogue" || thisClass == "fighter") &&
        current_class.level >= 3
      ) {
        if (
          current_class.hasOwnProperty("subclassDefinition") &&
          current_class.subclassDefinition != null
          ...
          if (
            current_class.subclassDefinition.name == "Arcane Trickster" ||
            current_class.subclassDefinition.name == "Eldritch Knight"
          ) {
            buildXML +=
    ...
    if (character.preferences.hitPointType == "2") {
      totalHP =
        ...
        Math.floor((getTotalAbilityScore(character, 3) - 10) / 2) * totalLevels;
    } else {
      totalHP =
        addHP +
        sumHP +
    ...
    if (
      background == "" &&
      character.background.customBackground.name != null
    ) {
      background = character.background.customBackground.name;
    }

    buildXML +=
      '\t\t<background type="string">' + background + "</background>\n";
    ...
    languages.some(function (current_lang, i) {
      if (current_lang.subType != "select-a-standard-language") {
        ...
        buildXML +=
          '\t\t\t\t<name type="string">' +
          capitalizeFirstLetter(current_lang.subType) +
          "</name>\n";
        buildXML += "\t\t\t</id-" + thisIteration + ">\n";
      }
    });
    ...
    $.each(
      character.background.definition.grantedFeats,
      function (key32, val32) {
        featValue = 0;
        if (val32.name != "Ability Scores") {
          ...
          $.each(character.feats, function (key001, val001) {
            if (val001.definition.id == thisFeat2[0]) {
              ...
              buildXML += "\t\t\t<effectlist />\n";
              buildXML +=
                '\t\t\t<name type="string">' + val32.name + "</name>\n";
              buildXML += '\t\t\t<text type="formattedtext">\n';
              buildXML +=
                "\t\t\t\t<p>" + val001.definition.description + "</p>\n";
              buildXML += "\t\t\t</text>\n";
    ...
    buildXML +=
      '\t\t\t<total type="number">' + parseInt(charWalk) + "</total>\n";
    buildXML += "\t\t</speed>\n";
    ...
    var proficiencies = getObjects(character, "type", "proficiency");
    if (proficiencies != null)
      proficiencies.some(function (prof, i) {
        if (typeof prof.friendlySubtypeName == "undefined") {
          //  Rework this TODO
        } else {
          if (
            prof.friendlySubtypeName.match(/Saving\sThrows/) ||
            holdProf.includes(prof.friendlySubtypeName)
          ) {
            ...
            switch (prof.friendlySubtypeName) {
              ...
              default:
                ...
                buildXML +=
                  '\t\t\t\t<name type="string">' +
                  fixQuote(prof.friendlySubtypeName) +
                  "</name>\n";
                buildXML += "\t\t\t</id-" + thisIteration + ">\n";
            }
          }
    ...
    buildXML +=
      '\t\t<height type="string">' + fixQuote(character.height) + "</height>\n";
    if (character.weight != null)
      buildXML +=
        '\t\t<weight type="string">' + character.weight + "</weight>\n";
    buildXML +=
      '\t\t<gender type="string">' + fixQuote(character.gender) + "</gender>\n";
    ...
    buildXML +=
      '\t\t<deity type="string">' + fixQuote(character.faith) + "</deity>\n";
    ...
    buildXML += '\t\t\t<misc type="number">0</misc>\n';
    buildXML += '\t\t\t<total type="number">' + initTotal + "</total>\n";
    buildXML += "\t\t</initiative>\n";
    ...
    character.spells.race.some(function (eachSpell, i) {
      if (!spellList.includes(eachSpell.definition.name)) {
        ...
        if (eachSpell.definition.components.indexOf(3) != -1) {
          componentList +=
            "M (" + eachSpell.definition.componentsDescription + "), ";
        }
        ...
        buildXML += '\t\t\t\t<description type="formattedtext">\n';
        buildXML +=
          "\t\t\t\t\t" + fixDesc(eachSpell.definition.description) + "\n";
        buildXML += "\t\t\t\t</description>\n";
        if (eachSpell.definition.duration.durationType == "Time") {
          buildXML +=
            '\t\t\t\t<duration type="string">' +
            eachSpell.definition.duration.durationInterval +
            " " +
            eachSpell.definition.duration.durationUnit +
            "</duration>\n";
        } else if (
          eachSpell.definition.duration.durationType == "Instantaneous"
        ) {
          buildXML +=
        ...
        buildXML +=
          '\t\t\t\t<level type="number">' +
          eachSpell.definition.level +
          "</level>\n";
        buildXML += '\t\t\t\t<locked type="number">1</locked>\n';
        buildXML +=
          '\t\t\t\t<name type="string">' +
          fixQuote(eachSpell.definition.name) +
          "</name>\n";
        ...
        if (eachSpell.definition.range.origin == "Ranged") {
          buildXML +=
            '\t\t\t\t<range type="string">' +
            eachSpell.definition.range.rangeValue +
            "</range>\n";
        ...
        buildXML +=
          '\t\t\t\t<school type="string">' +
          fixQuote(eachSpell.definition.school) +
          "</school>\n";
        if (payFlag == 1) {
    ...
    character.spells.class.some(function (eachSpell, i) {
      if (eachSpell.definition == null) {
        console.log("No spell here");
      } else if (!eachSpell.definition.hasOwnProperty("name")) {
            ...
            if (!spellList.includes(spell.definition.name)) {
              ...
              if (
                ...
                if (spell.definition.components.indexOf(3) != -1) {
                  componentList +=
                    "M (" + spell.definition.componentsDescription + ")* ";
                }
                componentList = componentList.trim().slice(0, -1);
                ...
                buildXML += '\t\t\t\t<description type="formattedtext">\n';
                buildXML +=
                  "\t\t\t\t\t" + fixDesc(spell.definition.description) + "\n";
                buildXML += "\t\t\t\t</description>\n";
                if (spell.definition.duration.durationType == "Time") {
                  ...
                  spell.definition.duration.durationType == "Instantaneous"
                ) {
                  buildXML +=
                    '\t\t\t\t<duration type="string">Instantaneous</duration>\n';
                }
                ...
                buildXML +=
                  '\t\t\t\t<level type="number">' +
                  spell.definition.level +
                  "</level>\n";
                buildXML += '\t\t\t\t<locked type="number">1</locked>\n';
                buildXML +=
                  '\t\t\t\t<name type="string">' +
                  fixQuote(spell.definition.name) +
                  "</name>\n";
                buildXML += '\t\t\t\t<prepared type="number">0</prepared>\n';
                ...
                buildXML +=
                  '\t\t\t\t<school type="string">' +
                  fixQuote(spell.definition.school) +
                  "</school>\n";
                if (payFlag == 1) {
                  buildXML += '\t\t\t\t<parse type="number">1</parse>\n';
                }
    ...
    if (payFlag == 1) {
      ...
      if (isBarbarian == 1) {
        ...
        buildXML +=
          '\t\t\t\t<prepared type="number">' + barbRages + "</prepared>\n";
        buildXML += "\t\t\t</id-" + thisIteration + ">\n";
        if (levelBarbarian >= 2) {
          thisIteration = pad(totalSpells + 1, 5);
          totalSpells += 1;
